<template>
    <div>
        <div style="display: flex;justify-content: center;margin-top: 10px">
            <el-input placeholder="通过用户名搜索..." prefix-icon="el-icon-search" style="width: 400px;margin-right: 10px" v-model="keywords" @click="doSearch"></el-input>
        ...
        <div class="admin-container">
            <el-card class="admin-card" v-for="(admin, index) in admins" :key="index">
                <div slot="header" class="clearfix">
                    ...
                    <el-button style="float: right; padding: 3px 0;color: red" icon="el-icon-delete" type="text" @click="deleteAdmin"></el-button>
                </div>
                <div>
                ...
                <div class="userinfo-container">
                    ...
                    <div>
                        用户角色:
                        <el-tag type="success" v-for="(role, indexj) in admin.roles" :key="indexj" style="margin-right: 4px">
                            {{role.nameZh}}
                        </el-tag>
                        <el-popover
                            placement="right"
